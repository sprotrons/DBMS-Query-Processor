...
public class MFStructOrig
{
	...
	public ArrayList<String> lst_Having = new ArrayList<String>();
	...
	public MFStructOrig(MFStructOrig orig)
	{
		...
		this.lst_Having = orig.lst_Having;
	}
	...
	public MFStructOrig()
	{
		...
		this.lst_Having = new ArrayList<String>();
	}
...
//				System.out.println(strAttr);
	...
	// having conditions
	public void setHaving(String curLine)
	{
//		System.out.println("Conditions:");
		int j = 0;
		for(int i = 0; i != curLine.length(); i++)
...
//				System.out.println(strAttr);
		...
		lst_Having = this.toLowerCase(lst_Having);
	}
	
	// having conditions file version
	public void setHaving(BufferedReader br, String curLine) {
//		System.out.println("Having Conditions:");
		//Check output
		try
		{
			curLine = br.readLine();
